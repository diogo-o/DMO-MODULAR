...
// 
// The Peso PDF generation action is intentionally NOT part of this surface (P2-T08 correction:
// Create owns the operational document work; Approve owns only the decision).
//

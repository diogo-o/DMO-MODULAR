...
public sealed class ControloComparacaoServiceTests
{
    ...
    {
        public Dictionary<Guid, DMO.Domain.ControloComparacao.Comparacao> Store { get; } = new();

        public Task<DMO.Domain.ControloComparacao.Comparacao?> GetByIdAsync(Guid comparacaoId, CancellationToken cancellationToken) =>
            Task.FromResult(Store.GetValueOrDefault(comparacaoId));

        public Task<DMO.Domain.ControloComparacao.Comparacao?> GetByPesoIdAsync(Guid pesoId, CancellationToken cancellationToken) =>
        ...
        public Task<DMO.Domain.ControloComparacao.Comparacao> StartedAsync(DMO.Domain.ControloComparacao.Comparacao comparacao, CancellationToken cancellationToken)
        {
            Store[comparacao.ComparacaoId.Value] = comparacao;
            return Task.FromResult(comparacao);
        }

        public Task<DMO.Domain.ControloComparacao.Comparacao> SubjectAddedAsync(
        ...
        public Task<DMO.Domain.ControloComparacao.Comparacao> MeasurementsRecordedAsync(
            ComparacaoCmSubject subject,
        ...
        public Task<DMO.Domain.ControloComparacao.Comparacao> DecidedAsync(
            ComparacaoCmSubject subject,
            int expectedSubjectVersion,
            CancellationToken cancellationToken)
        {
        ...
        public Task<DMO.Domain.ControloComparacao.Comparacao> ConfirmedAsync(
            DMO.Domain.ControloComparacao.Comparacao comparacao,
            int expectedComparacaoVersion,
            CancellationToken cancellationToken)
        {
        ...
        private static ComparacaoCmSubject Subject(DMO.Domain.ControloComparacao.Comparacao comparacao, Guid cmId) =>
